...
const unsigned long num_vertex = 30837; //vertex numbering goes from 0 to 4038
const unsigned long num_edges = 213954; //umber of lines in dataset, will be inly used to display progress bar

const char file_path[] = "Assignment 2/SNAP & KONECT/Datasets/Linux_KONECT/out.linux";
