...
const unsigned long numVertices = 30837; //vertex numbering goes from 0 to 4038
const unsigned long numEdges = 213954; //umber of lines in dataset, will be inly used to display progress bar

const char filePath[] = "Datasets/Linux_KONECT/out.linux";
