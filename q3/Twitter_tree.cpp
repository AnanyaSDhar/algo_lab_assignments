...
const long numVertices = 81306; //vertex numbering goes from 0 to 4038
const long numEdges = 1768149; //umber of lines in dataset, will be inly used to display progress bar

const char filePath[] = "Assignment 2/SNAP & KONECT/Datasets/Twitter_SNAP/twitter_combined.txt";
