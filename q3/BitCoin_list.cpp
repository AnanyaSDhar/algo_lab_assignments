...
const unsigned long num_vertex = 3783; //vertex numbering goes from 0 to 4038
const unsigned long num_edges = 24186; //umber of lines in dataset, will be inly used to display progress bar

const char file_path[] = "Assignment 2/SNAP & KONECT/Datasets/BitCoin_Alpha_KONECT/out.soc-sign-bitcoinalpha";
