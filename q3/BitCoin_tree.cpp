...
const unsigned long numVertices = 3783; //vertex numbering goes from 0 to 3783
const unsigned long numEdges = 24186; //umber of lines in dataset, will be inly used to display progress bar

//will try to save as much space as possible cause idk my lappy can handle this abomination or not

const char filePath[] = "Assignment 2/SNAP & KONECT/Datasets/Facebook_SNAP/facebook_combined.txt";
...
int main()
{
    ...
    for (int i = 0; i < numEdges; i++)
    {
        ...
        cout << (float)i / numEdges * 100 << "% done \r";
    }
